<template>
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Advisors</h2>
    </template>
        ...
        <table class="shadow-lg border mt-4 ml-12 rounded-xl w-11/12">
          ...
          <tbody>
            <tr v-for="item in balances.data" :key="item.id">
              ...
              <td Style="width: 30%" class="py-2 px-2 border text-center">
                <inertia-link
                  class="
                    border
                    rounded-xl
                    ...
                    hover:bg-blue-600
                  "
                  :href="route('advisors.edit', item.id)"
                >
                  <span>Edit</span>
                </inertia-link>
                <inertia-link
