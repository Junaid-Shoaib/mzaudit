        ...
        <table class="shadow-lg border mt-4 ml-12 rounded-xl w-11/12">
          <thead>
			...
			c0,1.105,0.896,2,2,2h27.135c1.104,0,2-0.895,2-2v-3.842C89.255,90.732,88.361,89.838,87.255,89.838z"
              ...
              <th class="px-3 pt-3 pb-3 border">Phone No.</th>
              <th class="px-3 pt-3 pb-3 border">Email</th>
          ...
          <tbody>
            <tr v-for="item in balances.data" :key="item.id">
              ...
              <td Style="width: 35%" class="py-2 px-2 border text-center">
                {{ item.address }}
              </td>
              <td Style="width: 10%" class="py-2 px-2 border text-center">
                {{ item.phone }}
              </td>
              <td Style="width: 12%" class="py-2 px-2 border text-center">
                {{ item.email }}
              </td>
              <td Style="width: 8%" class="py-2 px-2 border text-center">
                {{ item.fiscal }}
              </td>
              <td Style="width: 10%" class="py-2 px-2 border text-center">
                <inertia-link
