<template>
    <app-layout>
        ...
        <div class="relative mt-5 ml-7">
            <inertia-link class="border bg-indigo-300 rounded-xl px-4 py-1 m-1" :href="route('banks.create')">Create
            </inertia-link>
        </div>        
        <div class="">
                ...
                <tbody>
                    <tr v-for="item in data" :key="item.id">
                        ...
                        <td class="py-1 px-4 border">
                            <inertia-link class="border bg-indigo-300 rounded-xl px-4 py-1 m-1" :href="route('banks.edit',item.id)">
                                <span>Edit</span>
                            </inertia-link>        
